...
const coverLetterDeliveryChannelTexts: Record<DeliveryChannel, Record<PromptLanguage, string>> = {
  email: {
    english: `This cover letter will be sent as an email. It should sound professional, respectful, and well-structured, with a clear greeting, body, and closing. Ideal length: 3–4 short paragraphs (around 250–300 words).`,
  ...
  applicationForm: {
    english: `This text will be submitted through an online job application form. It should be concise, ATS-friendly, and focus directly on relevant achievements. Ideal length: 2–3 paragraphs (around 180–220 words).`,
  ...
  internalReferral: {
    english: `This letter is for an internal referral. It should sound warm, confident, and highlight both professional fit and shared company values. Ideal length: 2–3 short paragraphs (around 200 words).`,
