...
const CV_MAIN_TASKS: Record<PromptLanguage, string> = {
  english: `
...
9. Mantén la sección "perfil profesional" concisa, de 120 a 150 palabras y con forma de "narración" de experiencias.
