...
const coverLetterToneTexts: Record<ToneLevel, Record<PromptLanguage, string>> = {
  formal: {
    english: `Use a formal and respectful tone, with precise wording and structured sentences. Avoid contractions and maintain a professional distance. Ideal for traditional corporate roles.`,
  ...
  enthusiast: {
    english: `Use an enthusiastic and positive tone that conveys genuine motivation and excitement about the role. Keep it professional but lively, showing passion and drive.`,
  ...
  casual: {
    english: `Use a relaxed and friendly tone, similar to natural conversation. Avoid excessive formality while keeping professionalism. Best suited for startups or creative environments.`,
  ...
  neutral: {
    english: `Use a balanced and neutral tone — polite, professional, and straightforward. Avoid emotional extremes and maintain clarity and objectivity throughout.`,
  ...
  confident: {
    english: `Use a confident and assertive tone that reflects self-assurance and credibility. Highlight achievements and strengths naturally, without arrogance.`,
