...
import { IaService } from './services/ia-service/ia.service';
...
import { TemperatureLevel } from '@smartcv/types';
...
import { CvForm, CvPayload, TransformedCvResponse } from '@smartcv/types';
