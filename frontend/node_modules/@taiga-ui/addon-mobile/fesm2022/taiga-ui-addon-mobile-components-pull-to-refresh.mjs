...
import { inject, Component, ChangeDetectionStrategy, InjectionToken, Injectable, Input, Output } from '@angular/core';
 ...
 */
const TUI_PULL_TO_REFRESH_LOADED = new InjectionToken(ngDevMode ? 'TUI_PULL_TO_REFRESH_LOADED' : '', {
    factory: () => EMPTY,
});
/**
 * Pull threshold in pixels until loading starts
 */
const TUI_PULL_TO_REFRESH_THRESHOLD = new InjectionToken(ngDevMode ? 'TUI_PULL_TO_REFRESH_THRESHOLD' : '', {
    factory: () => 50,
});
/**
 * Loading indicator component that gets current pull distance in pixels as context
 */
const TUI_PULL_TO_REFRESH_COMPONENT = new InjectionToken(ngDevMode ? 'TUI_PULL_TO_REFRESH_COMPONENT' : '', {
