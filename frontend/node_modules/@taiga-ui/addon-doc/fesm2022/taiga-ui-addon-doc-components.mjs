 ...
 * Page title
 */
const NAVIGATION_TITLE = new InjectionToken(ngDevMode ? 'NAVIGATION_TITLE' : '');
/**
 * Navigation sections labels for search
 */
const NAVIGATION_LABELS = new InjectionToken(ngDevMode ? 'NAVIGATION_LABELS' : '');
/**
 * Navigation pages
 */
const NAVIGATION_ITEMS = new InjectionToken(ngDevMode ? 'NAVIGATION_ITEMS' : '');
 ...
 */
const PAGE_SEE_ALSO = new InjectionToken(ngDevMode ? 'PAGE_SEE_ALSO' : '');
...
const TUI_THEMES = new InjectionToken(ngDevMode ? 'TUI_THEMES' : '', {
    factory: () => ({}),
});
