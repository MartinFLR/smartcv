...
import { inject, Directive, InjectionToken, Component, ViewEncapsulation, ChangeDetectionStrategy, INJECTOR, EventEmitter, afterNextRender, Input, Output, ContentChildren, forwardRef, ElementRef, ChangeDetectorRef, TemplateRef, ViewChild } from '@angular/core';
...
import { tuiProvideOptions, tuiWithStyles, tuiPx, tuiPure } from '@taiga-ui/cdk/utils/miscellaneous';
import { __decorate } from 'tslib';
import { EMPTY_QUERY } from '@taiga-ui/cdk/constants';
import { DOCUMENT, AsyncPipe, NgFor, NgIf, NgTemplateOutlet } from '@angular/common';
 ...
 */
const TUI_TABS_OPTIONS = new InjectionToken(ngDevMode ? 'TUI_TABS_OPTIONS' : '', {
