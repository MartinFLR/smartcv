...
import { InjectionToken, Component, ViewEncapsulation, ChangeDetectionStrategy, inject, Directive, ContentChild, Input } from '@angular/core';
...
const TUI_BLOCK_OPTIONS = new InjectionToken(ngDevMode ? 'TUI_BLOCK_OPTIONS' : '', {
