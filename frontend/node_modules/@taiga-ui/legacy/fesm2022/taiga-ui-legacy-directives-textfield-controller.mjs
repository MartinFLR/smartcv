...
import { InjectionToken, Directive, Input, NgModule, ChangeDetectorRef } from '@angular/core';
...
const TUI_TEXTFIELD_APPEARANCE_DIRECTIVE = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_APPEARANCE_DIRECTIVE' : '', {
...
const TUI_TEXTFIELD_CLEANER = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_CLEANER' : '', {
...
const TUI_TEXTFIELD_CUSTOM_CONTENT = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_CUSTOM_CONTENT' : '', {
...
const TUI_TEXTFIELD_FILLER = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_FILLER' : '', {
...
const TUI_TEXTFIELD_ICON = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_ICON' : '', {
...
const TUI_TEXTFIELD_ICON_LEFT = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_ICON_LEFT' : '', {
...
const TUI_TEXTFIELD_LABEL_OUTSIDE = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_LABEL_OUTSIDE' : '', {
...
const TUI_TEXTFIELD_POSTFIX = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_POSTFIX' : '', {
...
const TUI_TEXTFIELD_PREFIX = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_PREFIX' : '', {
...
const TUI_TEXTFIELD_SIZE = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_SIZE' : '', {
...
const TUI_TEXTFIELD_WATCHED_CONTROLLER = new InjectionToken(ngDevMode ? 'TUI_TEXTFIELD_WATCHED_CONTROLLER' : '');
