...
import { TemplateRef, Component, ChangeDetectionStrategy, Input, InjectionToken, inject, ViewChild, ContentChild, Directive, NgModule } from '@angular/core';
 ...
 * @deprecated use new version of {@link https://taiga-ui.dev/components/select TuiSelect} (from @taiga-ui/kit) instead
 */
const TUI_SELECT_OPTIONS = new InjectionToken(ngDevMode ? 'TUI_SELECT_OPTIONS' : '', {
